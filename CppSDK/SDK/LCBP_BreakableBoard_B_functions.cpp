...
#include "LCBP_BreakableBoard_B_classes.hpp"
#include "LCBP_BreakableBoard_B_parameters.hpp"
...
void ALCBP_BreakableBoard_B_C::BulletHitEvent(const struct FVector& HitLocation, const struct FVector& HitDirection, double HitDamage, double HitStunPower, double DoT_Damage, double DoT_Stun, double DoT_Time, double DoT_Interval, bool IsPenetrated, class FName HitBoneName, const struct FVector& AttackLocation, class AActor* ShooterActor, EPhysicalSurface HitSurfaceType, bool IsMultipleShot, class FName ShotID, class FName AmmoRowName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LCBP_BreakableBoard_B_C", "BulletHitEvent");

	Params::LCBP_BreakableBoard_B_C_BulletHitEvent Parms{};
...
void ALCBP_BreakableBoard_B_C::DoTEvent(double Damage, double Stun, class FName AttackerRowName, class FName AmmoRowName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LCBP_BreakableBoard_B_C", "DoTEvent");

	Params::LCBP_BreakableBoard_B_C_DoTEvent Parms{};
...
void ALCBP_BreakableBoard_B_C::ExecuteUbergraph_LCBP_BreakableBoard_B(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LCBP_BreakableBoard_B_C", "ExecuteUbergraph_LCBP_BreakableBoard_B");

	Params::LCBP_BreakableBoard_B_C_ExecuteUbergraph_LCBP_BreakableBoard_B Parms{};
