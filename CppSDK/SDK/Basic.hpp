...
namespace Offsets
{
	constexpr int32 GObjects          = 0x08606570;
	constexpr int32 AppendString      = 0x0121D810;
	constexpr int32 GNames            = 0x08522E00;
	constexpr int32 GWorld            = 0x08782E30;
	constexpr int32 ProcessEvent      = 0x01443CA0;
