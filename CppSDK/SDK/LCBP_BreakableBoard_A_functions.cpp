...
#include "LCBP_BreakableBoard_A_classes.hpp"
#include "LCBP_BreakableBoard_A_parameters.hpp"
...
void ALCBP_BreakableBoard_A_C::BulletHitEvent(const struct FVector& HitLocation, const struct FVector& HitDirection, double HitDamage, double HitStunPower, double DoT_Damage, double DoT_Stun, double DoT_Time, double DoT_Interval, bool IsPenetrated, class FName HitBoneName, const struct FVector& AttackLocation, class AActor* ShooterActor, EPhysicalSurface HitSurfaceType, bool IsMultipleShot, class FName ShotID, class FName AmmoRowName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LCBP_BreakableBoard_A_C", "BulletHitEvent");

	Params::LCBP_BreakableBoard_A_C_BulletHitEvent Parms{};
...
void ALCBP_BreakableBoard_A_C::DoTEvent(double Damage, double Stun, class FName AttackerRowName, class FName AmmoRowName)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LCBP_BreakableBoard_A_C", "DoTEvent");

	Params::LCBP_BreakableBoard_A_C_DoTEvent Parms{};
...
void ALCBP_BreakableBoard_A_C::ExecuteUbergraph_LCBP_BreakableBoard_A(int32 EntryPoint)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("LCBP_BreakableBoard_A_C", "ExecuteUbergraph_LCBP_BreakableBoard_A");

	Params::LCBP_BreakableBoard_A_C_ExecuteUbergraph_LCBP_BreakableBoard_A Parms{};
